...
const sendFileToIPFS = async (
  ...
  imageHashRef: { current: any },
  setImageHash: React.Dispatch<React.SetStateAction<string>>,
  setImageUploadPending: React.Dispatch<React.SetStateAction<boolean>>,
  setImageUploadSuccessful: React.Dispatch<React.SetStateAction<boolean>>,
) => {
