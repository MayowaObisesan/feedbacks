...
// Encrypt function
export async function encryptClient(text: string, key: CryptoKey): Promise<string> {
...
// Decrypt function
export async function decryptClient(encryptedText: string, key: CryptoKey): Promise<string | null> {
  try {
